...
/**
 * @author kkontog, ktsiouni, mgrigori This class hides the complexities of the
 *         system by exposing only high level interfaces to the
 *         {@link warehouse.proxies.Proxy} class (using Facade design pattern),
 *         it utilizes operations in the {@link warehouse.controller.Controller}
 *         for the interface implementations.
 */
public class Facade implements FacadeCommands {
     ...
     * 
     * @see
     * warehouse.frontend.interfaces.FacadeCommands#placeOrder(java.util.Map,
     * warehouse.client.Buyer)
     */
    @Override
    public void placeOrder(Map<String, Integer> orderDetails, Buyer buyer) {
	// The buyer places the order according to orderDetails. The stock
	// should be depleted
	// accordingly and the buyer needs to make the payment using the
	// invoice.
     ...
     * (non-Javadoc)
     * 
     * @see warehouse.frontend.interfaces.FacadeCommands#restock(java.util.Map,
     * warehouse.client.Supplier)
     */
    @Override
    public void restock(Map<String, Integer> restockDetails, Supplier supplier) {
	// The supplier restock the supplies according to restockDetails. The
	// stock should be
     ...
     * 
     * @param orderDetails
     *            the name and quantity of each item in the order.
     * @param client
     *            the person who creates the order.
