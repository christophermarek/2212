...
/**
 * @author kkontog, ktsiouni, mgrigori This class is responsible for creating
 *         different strategies (using Factory design pattern) which implement
 *         {@link AggregatePricingStrategy} interface based on different
 *         contexts.
 */
public class AggregatePricingStrategyFactory {
     ...
     * 
     * @param type
     *            each type is attached to one strategy.
