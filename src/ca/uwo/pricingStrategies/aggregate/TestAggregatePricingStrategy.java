...
/**
 * @author kkontog, ktsiouni, mgrigori This class is one concrete implementation
 *         of {@link AggregatePricingStrategy} interface.
 */
public class TestAggregatePricingStrategy implements AggregatePricingStrategy {
     ...
     * (non-Javadoc)
     * 
     * @see ca.uwo.pricingStrategies.aggregate.AggregatePricingStrategy#
     * calculateTotal(java.util.Map)
     */
    @Override
