...
/**
 * @author kkontog, ktsiouni, mgrigori This class represents a collection of
 *         {@link ca.uwo.model.Item} in the database.
 */
public class ItemRepository {
     ...
     * 
     * @param orderItem
     *            one entry in the order.
     */
    public void depleteItemStock(OrderItem orderItem) {
	// First try to get the item from savedItems using the name of the item,
	// if not there,
	// get the item from the database. Then deplete the item with correct
	// quantity and update the
	...
	// First try to get the item from savedItems using the name of the item,
	// if not there,
	// get the item from the database. Then replenish the item with correct
	// quantity and update the
	// database. You should also update orderItem accordingly.
